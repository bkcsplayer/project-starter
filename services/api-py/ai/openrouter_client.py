# OpenRouter client (Python)
# - MUST call init_openrouter_models() on startup (fetch GET /models once per run)
# - Reasoning tasks must send reasoning: { effort: "high" }
...
APP_NAME = os.getenv("APP_NAME", "project-starter")
